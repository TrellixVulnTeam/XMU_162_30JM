...
CMplot(result1,plot.type="c",chr.labels=paste("Chr",c(1:22),sep=""),r=0.4,cir.legend=TRUE,
...
#-----------------------------------------------------
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/script/test")
CMplot(result1,plot.type="c",chr.labels=paste("Chr",c(1:22),sep=""),r=0.6,cir.legend=TRUE,
