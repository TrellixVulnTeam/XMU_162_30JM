...
org$xQTL<-factor(org$xQTL)

pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3.pdf",height = 6,width = 7)
p1<-ggplot(org, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.35) 
p1<-p1+xlab("Emplambda") + ylab("Count")
print(p1)
dev.off()

org1<-filter(org,emplambda<0.75)
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.75.pdf",height = 6,width = 7)
...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.65.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.35) 
p1<-p1+xlab("Emplambda") + ylab("Count")
print(p1)
dev.off()
...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.55.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.35) 
p1<-p1+xlab("Emplambda") + ylab("Count")
print(p1)
dev.off()
...
org1<-filter(org,emplambda<0.5)
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.5.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.35) 
p1<-p1+xlab("Emplambda") + ylab("Count")
print(p1)
dev.off()
