...
org_pop<-read.table("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/merge_QTL_all_QTLtype_pop_1kg_Completion.txt.gz",header = T,sep = "\t") %>% as.data.frame()
#----mkdir and set pwd
xQTL="QTL"
cutoff = 7.3
j = 6
