#("eQTL","caQTL","edQTL","hQTL","mQTL","pQTL","reQTL","sQTL"#中按照相同染色体位置，两两取交集，得../output/xQTL_merge/NHPoisson_emplambda_interval_1000_cutoff_7.3_all_merge_${QTL1}_${QTL2}.txt.gz
