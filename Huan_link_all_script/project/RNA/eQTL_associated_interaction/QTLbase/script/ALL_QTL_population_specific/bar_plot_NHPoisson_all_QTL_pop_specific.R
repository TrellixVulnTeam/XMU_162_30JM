...
in_file <-paste("../output/population_specific/count_number_by_emplambda_in_different_interval_cutoff_7_all_QTL_",pop,"_specific.txt",sep = "")
org<-read.table(in_file,header = T,sep = "\t") %>% as.data.frame()
...
figure_name<-paste("./population_specific/bar_plot_cutoff7_snp_number_in_different_interval_all_",pop,"_QTL.pdf",sep = "")
