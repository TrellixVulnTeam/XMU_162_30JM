...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_eQTL/chr/")
...
ProcessBedGz <- function(j = NULL){
    ...
    hist_figure_name1 <-paste("histogram_plot_cutoff_7.3_interval_",j,"_all_",xQTL,".pdf", sep = "")
    pdf(hist_figure_name1) 
    p1<-marrangeGrob(figure_list,nrow=3,ncol=3)  
    print(p1)
    dev.off()
    hist_figure_name2 <-paste("density_plot_cutoff_7.3_interval_",j,"_all_",xQTL,".pdf", sep = "")
