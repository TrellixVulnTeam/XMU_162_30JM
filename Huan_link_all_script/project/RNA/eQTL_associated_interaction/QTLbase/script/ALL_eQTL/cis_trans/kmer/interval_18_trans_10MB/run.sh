...
seekr_kmer_counts ../../../../../output/ALL_eQTL/cis_trans/kmer/interval_18/trans_10MB/interval_18_cutoff_7.3_trans_10MB_eQTL_segment_hotspot_length_more_than6.fa -o cis_1MB_6mers.csv -mv mean.npy -sv std.npy
