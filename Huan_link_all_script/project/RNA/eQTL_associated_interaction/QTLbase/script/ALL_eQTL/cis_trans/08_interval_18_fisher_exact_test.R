...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_18/annotation_out/fisher_exact_test/")
org1<-read.table("07_interval_18_prepare_fisher_test.txt",header =  T,sep = "\t") %>% as.data.frame()
