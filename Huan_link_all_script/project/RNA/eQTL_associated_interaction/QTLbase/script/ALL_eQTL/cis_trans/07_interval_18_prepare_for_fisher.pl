##看各种factor在#"~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_18/annotation_out/01_annotation_merge_${group}_${type}.txt.gz 的fisher exact test 准备数据,
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_18/annotation_out/fisher_exact_test/07_interval_18_prepare_fisher_test.txt";
...
foreach my $type(@types){
    ...
    my $f1 = "~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_18/annotation_out/05_annotation_merge_hotspot_${type}.txt.gz";
    # open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
    open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件
    #--------------------
    my $f2 = "~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_18/annotation_out/05_annotation_merge_non_hotspot_${type}.txt.gz";
    # open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
