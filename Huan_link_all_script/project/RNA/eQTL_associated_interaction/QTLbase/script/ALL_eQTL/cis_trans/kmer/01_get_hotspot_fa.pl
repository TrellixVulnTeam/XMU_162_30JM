...
foreach my $interval(@intervals){
    ...
    foreach my $type(@types){
        ...
        my $input_file = "../../../../output/ALL_eQTL/cis_trans/hotspot/interval_${interval}_cutoff_7.3_${type}_eQTL_segment_hotspot_length_more_than6.bed.gz";
        my $output_file = "${output_dir}/interval_${interval}_cutoff_7.3_${type}_eQTL_segment_hotspot_length_more_than6.fa";
