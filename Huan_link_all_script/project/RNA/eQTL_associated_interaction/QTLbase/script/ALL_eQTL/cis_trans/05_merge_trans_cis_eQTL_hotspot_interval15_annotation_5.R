...
gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/annotation_out/05_annotation_merge_",group,"_",type,".txt.gz",sep = ""), "w")
