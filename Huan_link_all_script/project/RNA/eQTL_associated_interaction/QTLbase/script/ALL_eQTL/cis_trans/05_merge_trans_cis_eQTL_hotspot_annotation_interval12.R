...
# for (file in file2){
  ...
  name <- str_replace(file,"_interval_12_cutoff_7.3_","")  #replace #-------
...
for (fraction in fractions){
  for(group in groups){
    ...
    mclapply(types, function(type){
      setwd(paste("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans",group,sep="/")) #-----------background
      ...
      #-------------------------------------
      setwd(paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/fisher_exact_test_V2/annotation/interval_",interval,"/",group,"/",type,"/",fraction,"/"))


      files<- list.files(paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/fisher_exact_test_V2/annotation/interval_",interval,"/",group,"/",type,"/",fraction,"/"),"bed.gz")
      ...
      gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/fisher_exact_test_V2/annotation_out/",group,"/05_annotation_merge_",type,"_interval_",interval,"_overlap_fraction_",fraction,".txt.gz",sep = ""), "w")
