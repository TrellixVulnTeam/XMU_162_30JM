...
ProcessBedGz2 <- function(type = NULL){
  for (group in groups){
    ...
    #------------------
    gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/annotation_out/",group,"/",type,"/01_annotation_merge_",group,"_",type,".txt.gz"), "w")
