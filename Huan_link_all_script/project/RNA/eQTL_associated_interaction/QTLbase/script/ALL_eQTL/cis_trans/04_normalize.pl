#将"../../../output/ALL_eQTL/cis_trans/QTLbase_NHPoisson_emplambda_interval_1000_cutoff_7.3_all_cis_trans_eQTL.txt.gz" 处理成$cis_or_trans:$emplambda的格式，并将位置处理为bed
...
my $fo1 = "../../../output/ALL_eQTL/cis_trans/QTLbase_NHPoisson_emplambda_interval_1000_cutoff_7.3_all_cis_trans_eQTL_normalized.bed.gz";
open my $O1, "| gzip >$fo1" or die $!;
# my $fo2 = "../../../output/ALL_eQTL/cis_trans/value_more_than1.txt";
# # open my $O2, "| gzip >$fo2" or die $!;
# open my $O2, '>', $fo2 or die "$0 : failed to open output file '$fo2' : $!\n";
my %hash1;
print $O1 "chr\tstart\tend\tpos\tcis_trans\n";
# my %name;
while(<$I1>)
{
    chomp;
    unless(/^emplambda/){
        ...
        my $cis_or_trans = $f[3];
        my $k = "$final_chr\t$start\t$end\t$pos";
        my $v = "$cis_or_trans:$emplambda"; 
        push @{$hash1{$k}},$v;
    }
}
