...
# for (j in interval){
fun=function(j){
    dir_name = paste("all_eQTLbase_cutoff_",cutoff,"_int",interval[j], sep = "")
    #----------------------------------mkdir_dir
    ...
    for(i in c(1:22)){
        ...
        figure_name <-paste(dir_name,"/emplambda_all_eQTL_int_",interval[j],"bp_chr",i,".png", sep = "")
    ...
    output_file1<-paste("../../output/ALL_eQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_eQTLbase.txt", sep = "")
    output_file2<-paste("../../output/ALL_eQTL/NHPoisson_emplambda_interval_",interval[j],"_all_eQTLbase.txt", sep = "")
    output_file3<-paste("../../output/ALL_eQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_eQTLbase.txt", sep = "")
