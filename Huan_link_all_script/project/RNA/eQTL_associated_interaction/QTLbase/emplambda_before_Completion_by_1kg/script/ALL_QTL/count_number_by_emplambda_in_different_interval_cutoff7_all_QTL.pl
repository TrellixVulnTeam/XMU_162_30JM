#统计../output/NHPoisson_emplambda_interval_${i}_all_QTLbase.txt中 中每个阶段qtl的数目，得../output/count_number_by_emplambda_in_different_interval_cutoff_7_all_QTL.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "../output/count_number_by_emplambda_in_different_interval_cutoff_7_all_QTL.txt";
...
for (my $i=10000;$i<70000;$i=$i+10000){ #interval
    my $f1 = "../output/NHPoisson_emplambda_interval_${i}_all_QTLbase.txt";
