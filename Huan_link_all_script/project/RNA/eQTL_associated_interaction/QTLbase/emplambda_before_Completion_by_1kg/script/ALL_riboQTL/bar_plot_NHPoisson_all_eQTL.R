...
org<-read.table("../../output/ALL_eQTL/count_number_by_emplambda_in_different_interval_cutoff_7_all_eQTL.txt",header = T,sep = "\t") %>% as.data.frame()
...
pdf("bar_plot_cutoff7_snp_number_in_different_interval_all_eQTL.pdf",height = 60,width = 100) 
marrangeGrob(figure_list,nrow=3,ncol=5,top = "cutoff = 7" ,size = 20)  #指定list的具体位置，也可以直接用整个list组装，比如：figure_list
dev.off()
