...
for (cutoff in cutoffs){
    ...
    for (j in interval){
        ...
        figure_list[[i]] <-ggplot(org1, aes(x = log(emplambda), y =number ))+ 
    ...
    figure_name <-paste("bar_plot_cutoff_",cutoff,"_snp_number_in_different_interval_all_log_",xQTL,".pdf", sep = "")
