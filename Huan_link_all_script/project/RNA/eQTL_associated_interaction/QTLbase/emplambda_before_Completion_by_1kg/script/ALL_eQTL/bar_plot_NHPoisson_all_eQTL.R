...
pdf("bar_plot_cutoff7_snp_number_in_different_interval_all_eQTL.pdf",height = 30,width = 50) 
marrangeGrob(figure_list,nrow=3,ncol=5,top = "cutoff = 7")  #指定list的具体位置，也可以直接用整个list组装，比如：figure_list
dev.off()
# #-----------------------------
# for (j in interval){
#     org1<-filter(org, interval==j)
