...
pwd_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_edQTL"
...
org_pop <- filter(org,QTL_type == "edQTL")
# org_pop <- org
#--------------------500k
...
for (cutoff in cutoffs){
    for (j in interval){
        dir_name = paste("all_edQTL_cutoff_",cutoff,"_int",j, sep = "")
        #----------------------------------mkdir_dir
        ...
        for(i in c(1:22)){
            ...
            figure_name <-paste(dir_name,"/emplambda_all_edQTL_int_",j,"bp_chr",i,".png", sep = "")
        ...
        output_file1<-paste("../../output/ALL_edQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_edQTL.txt", sep = "")
        # output_file2<-paste("../../output/ALL_edQTL/NHPoisson_emplambda_interval_",j,"_all_edQTL.txt", sep = "")
        output_file2<-paste("../../output/ALL_edQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_edQTL.txt", sep = "")
        output_file3<-paste("../../output/ALL_edQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_edQTL.txt", sep = "")
