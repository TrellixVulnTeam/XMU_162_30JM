...
pwd_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_metaQTL"
...
org_pop <- filter(org,QTL_type == "metaQTL")
# org_pop <- org
#--------------------500k
...
for (cutoff in cutoffs){
    for (j in interval){
        dir_name = paste("all_metaQTL_cutoff_",cutoff,"_int",j, sep = "")
        #----------------------------------mkdir_dir
        ...
        for(i in c(1:22)){
            ...
            figure_name <-paste(dir_name,"/emplambda_all_metaQTL_int_",j,"bp_chr",i,".png", sep = "")
        ...
        output_file1<-paste("../../output/ALL_metaQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_metaQTL.txt", sep = "")
        output_file2<-paste("../../output/ALL_metaQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_metaQTL.txt", sep = "")
        output_file3<-paste("../../output/ALL_metaQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_metaQTL.txt", sep = "")
