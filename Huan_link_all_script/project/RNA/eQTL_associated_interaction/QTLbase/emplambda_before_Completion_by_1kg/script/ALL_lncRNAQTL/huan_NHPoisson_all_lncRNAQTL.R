...
pwd_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_lncRNAQTL"
...
setwd(pwd_dir)
#----------------mkdir output dir
output_dir= "../../output/ALL_lncRNAQTL"
...
org_pop <- filter(org,QTL_type == "lncRNAQTL")
# org_pop <- org
#--------------------500k
...
for (cutoff in cutoffs){
    for (j in interval){
        dir_name = paste("all_lncRNAQTL_cutoff_",cutoff,"_int",j, sep = "")
        #----------------------------------mkdir_dir
        ...
        for(i in c(1:22)){
            ...
            figure_name <-paste(dir_name,"/emplambda_all_lncRNAQTL_int_",j,"bp_chr",i,".png", sep = "")
        ...
        output_file1<-paste("../../output/ALL_lncRNAQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_lncRNAQTL.txt", sep = "")
        output_file2<-paste("../../output/ALL_lncRNAQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_lncRNAQTL.txt", sep = "")
        output_file3<-paste("../../output/ALL_lncRNAQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_lncRNAQTL.txt", sep = "")
