...
my $f2 = "/state/partition1/huan/tmp/02_hotspot_in_1kg_phase3_v5_eur_1MB_10000_0.2.ld_x000.gz";
# open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n"; 
open( my $I2 ,"gzip -dc $f2|") or die ("can not open input file '$f2' \n"); #读压缩文件
my $fo1 = "/state/partition1/huan/02_hotspot_in_1kg_phase3_v5_eur_1MB_10000_0.2.ld_x000_validate.gz";
