...
bedtools intersect -a ../../output/ALL_eQTL/un_hotspot/interval_15_segment_UNhotspot.bed.gz -b ../../annotation_data/hic/02_all_unique_hic_loops_tran_cis_2_sorted.bed.gz -wa -wb | gzip > ../output/annotation/non_hotspot/QTLbase_all_eQTL_interval_non_hotspot_15_hic_loops_2.bed.gz
