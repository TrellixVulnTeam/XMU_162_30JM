...
# bedtools intersect -a ../../output/ALL_eQTL/hotspot/interval_15_segment_hotspot.bed.gz -b ../../annotation_data/hic/02_all_unique_hic_loops_tran_cis_2_sorted.bed.gz -wa -wb | gzip > ../output/annotation/hotspot/QTLbase_all_eQTL_interval_hotspot_15_hic_loops_2.bed.gz
