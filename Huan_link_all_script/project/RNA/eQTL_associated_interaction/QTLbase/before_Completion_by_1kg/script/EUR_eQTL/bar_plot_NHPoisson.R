...
org<-read.table("../output/count_number_by_emplambda_in_different_interval_cutoff_7.txt",header = T,sep = "\t") %>% as.data.frame()
...
pdf("cutoff7_snp_number_in_different_interval.pdf",height = 20,width = 28) 
