...
#----------------------------------
org<-read.table("../output/QTLbase_chr22_and_1kg.txt",header = T,sep = "\t") %>% as.data.frame()
...
# figure_name <-paste(dir_name,"/emplambda_all_eQTL_before_2000",".png", sep = "")
figure_name <-"emplambda_all_eQTL_region_add.png"
