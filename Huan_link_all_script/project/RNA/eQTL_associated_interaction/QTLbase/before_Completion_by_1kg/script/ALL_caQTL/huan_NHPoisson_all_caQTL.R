...
for (cutoff in cutoffs){
    for (j in interval){
        ...
        output_file1<-paste("../../output/ALL_caQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_caQTL.txt", sep = "")
        output_file2<-paste("../../output/ALL_caQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_caQTL.txt", sep = "")
        output_file3<-paste("../../output/ALL_caQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_caQTL.txt", sep = "")
