...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/ROADMAP/Ovary/promoter/")

org<-read.table("01_normal_E097-H3K4me3.narrowPeaksorted.gz",header = F,sep = "\t") %>% as.data.frame()
org$length <-org$V3-org$V2
title_name <- "Ovary promoter"
