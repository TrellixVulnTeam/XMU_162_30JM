...
#---------------------------------
Rscript 02_plot_length_distribution_of_enhancer_and_calculate_mean.R #为01_normal_E062-H3K4me1_H3K27ac.narrowPeaksorted_overlap.gz 画长度分布图，得长度文件 02_enhancer_length.txt 和求均数及中位数得02_enhancer_length_statistics.txt

bedtools makewindows -b  01_enhancer_complement.bed.gz -w 334 | gzip >split_enhancer_complement.bed.gz
