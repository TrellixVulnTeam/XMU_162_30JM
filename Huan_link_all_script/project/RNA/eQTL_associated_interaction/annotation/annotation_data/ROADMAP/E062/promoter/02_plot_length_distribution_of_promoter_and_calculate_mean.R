...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/ROADMAP/E062/promoter/")

org<-read.table("01_normal_E062-H3K4me3.narrowPeaksorted.gz",header = F,sep = "\t") %>% as.data.frame()
