#过滤出needed_hsa_hg19_circRNA_sorted.bed.gz中的chr1_22,得03_needed_hsa_hg19_circRNA_sorted_chr1_22.bed.gz
...
my $fo1 = "03_needed_hsa_hg19_circRNA_sorted_chr1_22.bed.gz"; 
# open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
open my $O1, "| gzip >$fo1" or die $!;

my $fo2 ="03_needed_hsa_hg19_circRNA_sorted_chr1_22_extend_500bp.bed.gz";
# open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
open my $O2, "| gzip >$fo2" or die $!;

my $fo3 ="03_needed_hsa_hg19_circRNA_sorted_chr1_22_extend_100bp.bed.gz";  
# open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
open my $O3, "| gzip >$fo3" or die $!;

my $f1 = "needed_hsa_hg19_circRNA_sorted.bed.gz";
