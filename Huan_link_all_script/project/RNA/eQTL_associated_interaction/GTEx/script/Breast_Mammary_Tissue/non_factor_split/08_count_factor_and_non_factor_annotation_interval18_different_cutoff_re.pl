...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Lung/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/08_Lung_prepare_number_ROC_factor_count_re.txt";
...
foreach my $factor(@factors){
    ...
    foreach my $cutoff(@cutoffs){
        my $factor_hotspot_file = "../../../output/Lung/Cis_eQTL/annotation/interval_18/ALL/factor/hotspot/${cutoff}/${factor}_Lung_segment_hotspot_cutoff_${cutoff}.bed.gz";
        my $non_factor_hotspot_file = "../../../output/Lung/Cis_eQTL/annotation/interval_18/ALL/non_factor_split/hotspot/${cutoff}/non_${factor}_Lung_segment_hotspot_cutoff_${cutoff}.bed.gz";
        #--------------------------------------get size of file 
