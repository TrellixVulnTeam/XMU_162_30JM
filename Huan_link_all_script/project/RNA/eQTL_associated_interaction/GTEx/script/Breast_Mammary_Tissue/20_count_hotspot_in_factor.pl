#根据"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/061_hotspot_in_different_cutoff_interval_18_re.txt记录的hotspot数目，和annotation信息得每个cutoff下hit住factor的hotspot的比例文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_factor.txt.gz"; 得每个cutoff下被每种factor hit住hotspot的比例文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_per_factor_ratio.txt.gz";得每个cutoff下被每种factor hit住hotspot的文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_factor_pos.txt.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_factor.txt.gz";
open my $O1, "| gzip >$fo1" or die $!;
print $O1 "Cutoff\tnum_of_hotspot_hit_factor\tnum_all_hotspot\thit_ratio\n";
my $fo2 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_factor_pos.txt.gz";
open my $O2, "| gzip >$fo2" or die $!;
print $O2 "chr\tstart\tend\tfactor\tcutoff\n";

my $fo3 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_per_factor_ratio.txt.gz";
