 # 用"/share/data0/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.shapeit2.eur.hg19.all.SNPs.vcf.gz" 补全"${dir}/${tissue}${suffix}"; 得"../output/Breast_Mammary_Tissue_cis_eQTL_1kg_Completion.txt.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
use Parallel::ForkManager;
    ...
    my $tissue = "Breast_Mammary_Tissue";
    ...
    # }
    #---------------
    my $fo1 = "../../output/${tissue}/${tissue}_cis_eQTL_1kg_Completion.txt.gz";
