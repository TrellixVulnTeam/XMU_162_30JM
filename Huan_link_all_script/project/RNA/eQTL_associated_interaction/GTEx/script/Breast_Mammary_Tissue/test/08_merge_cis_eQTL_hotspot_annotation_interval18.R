...
tryCatch({
  for(group in groups){
    ...
    mclapply(cutoffs, function(cutoff){
      ...
      org1<-read.table(paste("whole_blood_segment_",group,"_cutoff_",cutoff,".bed.gz",sep=""),header = F,sep = "\t") %>% as.data.frame()
      colnames(org1)[1]<-"chr"
      ...
      #-------------------------------------
      setwd(paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/annotation/interval_18/ALL/",group,"/",cutoff,"/"))


      files<- list.files(paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/annotation/interval_18/ALL/",group,"/",cutoff,"/"),"bed.gz")
      ...
      gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/annotation_out/interval_18/ALL/",group,"/08_annotation_merge_interval_18_overlap_cutoff_",cutoff,".txt.gz",sep = ""), "w")
