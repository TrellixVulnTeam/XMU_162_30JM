...
# push @cutoffs,0.99;
    ...
    my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/09_prepare_number_ROC.txt";
    ...
    my $fo2 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/09_prepare_TPR_FPR_ROC.txt";
...
foreach my $cutoff(@cutoffs){
    ...
    #--------------------
    my $f2 = "~/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/annotation_out/interval_18/ALL/non_hotspot/08_annotation_merge_interval_18_overlap_cutoff_${cutoff}.txt.gz";
    # open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
