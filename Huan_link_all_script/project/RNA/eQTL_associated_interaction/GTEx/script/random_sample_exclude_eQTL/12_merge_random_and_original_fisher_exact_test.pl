#将#/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_sample/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/10_fisher_exact_test_result_factor_summary.txt和
...
#得/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_sample/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/12_merge_random_and_original_fisher_exact_test.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_sample/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/12_merge_random_and_original_fisher_exact_test.txt";
...
my $f3 ="/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_sample/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/10_fisher_exact_test_result_factor_summary.txt";
# open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件
