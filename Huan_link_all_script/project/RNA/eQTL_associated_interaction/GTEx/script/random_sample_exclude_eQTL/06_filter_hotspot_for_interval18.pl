...
foreach my $tissue(@tissues){
    foreach my $number(@numbers){
        ...
        my $f1 = "/share/data0/QTLbase/huan/GTEx/random_select_exclude_eQTL/${tissue}/NHP/NHPoisson_emplambda_interval_18_cutoff_7.3_${tissue}_${number}.txt.gz";
        ...
        my $output_dir = "/share/data0/QTLbase/huan/GTEx/random_select_exclude_eQTL/${tissue}/hotspot/${number}/interval_18";
        # #------------
        if(-e $output_dir){
