...
# perl 06_filter_non_hotspot_for_interval18.pl ###../output/Whole_Blood/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_Whole_Blood.txt.gz 时得不同cutoff下的non hotspot(segment),../output/${tissue}/Cis_eQTL/non_hotspot_cis_eQTL/interval_${j}/${tissue}_segment_non_hotspot_cutoff_${cutoff}.bed.gz
# #----------------------
...
perl 061_count_hotspot_in_different_cutoff_re.pl #统计不同cutoff下hotspot的数目/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18/，得/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/061_hotspot_in_different_cutoff_interval_18_re.txt
...
#-----------------
perl 31_annotation_chromatin_states.pl #