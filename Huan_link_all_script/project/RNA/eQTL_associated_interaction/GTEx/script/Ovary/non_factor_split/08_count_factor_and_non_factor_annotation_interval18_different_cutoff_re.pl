#根据/home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/${factor}.bed.gz， /home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/non_${factor}.bed.gz，../../../output/Ovary/Cis_eQTL/annotation/interval_18/ALL/factor/hotspot/${cutoff}/${factor}_Ovary_segment_hotspot_cutoff_${cutoff}.bed.gz，../../../output/Ovary/Cis_eQTL/annotation/interval_18/ALL/non_factor_split/hotspot/${cutoff}/non_${factor}_Ovary_segment_hotspot_cutoff_${cutoff}.bed.gz 以factor为基数，准备计算ROC的四格表得"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Ovary/Cis_eQTL/ROC/interval_18/ALL/08_prepare_number_ROC_refine_factor_count.txt"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Ovary/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/08_Ovary_prepare_number_ROC_factor_count_re.txt";
...
foreach my $factor(@factors){
    my $command_factor = "zless /home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/Ovary/${factor}_union.bed.gz | wc -l" ;
    my $command_non_factor = "zless /home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/Ovary/non_${factor}_split_union.bed.gz | wc -l" ;
    ...
    foreach my $cutoff(@cutoffs){
        my $factor_hotspot_file = "../../../output/Ovary/Cis_eQTL/annotation/interval_18/ALL/factor/hotspot/${cutoff}/${factor}_Ovary_segment_hotspot_cutoff_${cutoff}.bed.gz";
        my $non_factor_hotspot_file = "../../../output/Ovary/Cis_eQTL/annotation/interval_18/ALL/non_factor_split/hotspot/${cutoff}/non_${factor}_Ovary_segment_hotspot_cutoff_${cutoff}.bed.gz";
        #--------------------------------------get size of file 
...
#             my $input_file = "../output/Ovary/Cis_eQTL/${group}_cis_eQTL/interval_18/Ovary_segment_${group}_cutoff_${cutoff}.bed.gz";
...
#             my $output_dir = "../output/Ovary/Cis_eQTL/annotation/interval_18/ALL/${type}/${group}/${cutoff}"; 
#             # mkdir $PMID;
#             # #------------
#             if(-e $output_dir){
