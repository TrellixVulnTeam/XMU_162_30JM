...
xQTL ="eQTL"
org<-read.table("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood_eQTL_1kg_Completion.txt.gz",header = T,sep = "\t") %>% as.data.frame()
#----mkdir and set pwd
cutoff = 7.3
#----------------------------------------------
...
for (j in intervals){
    pwd_dir <-paste("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/figure/NHP/Cis_eQTL/interval_",j,"/",sep="")
    ...
    output_dir= paste("../../../output/NHP/Cis_eQTL/interval_",j,sep="")
    ...
    output_file1<-paste("../../output/Cis_eQTL/Whole_Blood/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_",xQTL,".txt", sep = "")
    output_file2<-paste("../../output/Cis_eQTL/Whole_Blood/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_",xQTL,".txt", sep = "")
    output_file3<-paste("../../output/Cis_eQTL/Whole_Blood/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_",xQTL,".txt", sep = "")
