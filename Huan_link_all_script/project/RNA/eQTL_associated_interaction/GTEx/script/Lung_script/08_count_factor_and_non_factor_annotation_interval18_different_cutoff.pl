#根据/home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/${factor}.bed.gz， /home/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/used_refer/non_${factor}.bed.gz，../output/Whole_Blood/Cis_eQTL/annotation/interval_18/ALL/factor/hotspot/${cutoff}/${factor}_whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz，../output/Whole_Blood/Cis_eQTL/annotation/interval_18/ALL/non_factor/hotspot/${cutoff}/non_${factor}_whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz 以factor为基数，准备计算ROC的四格表得"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/08_prepare_number_ROC_refine_factor_count.txt"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/08_prepare_number_ROC_refine_factor_count.txt";
...
foreach my $factor(@factors){
    ...
    foreach my $cutoff(@cutoffs){
        ...
        my $non_factor_hotspot_file = "../output/Whole_Blood/Cis_eQTL/annotation/interval_18/ALL/non_factor/hotspot/${cutoff}/non_${factor}_whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz";
        #--------------------------------------get size of file 
