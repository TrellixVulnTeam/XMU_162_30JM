...
# tryCatch({
  for(group in groups){
    ...
    for(cutoff in cutoffs){
      ...
      gz1 <- gzfile(paste("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/annotation_out/interval_18/",group,"/08_annotation_merge_interval_18_overlap_cutoff_",cutoff,"_chr1_22.txt.gz",sep = ""), "w")
