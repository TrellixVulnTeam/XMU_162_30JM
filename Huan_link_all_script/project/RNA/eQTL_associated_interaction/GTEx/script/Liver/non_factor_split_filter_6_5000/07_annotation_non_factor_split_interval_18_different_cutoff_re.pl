...
foreach my $type(@types){
    foreach my $group(@groups){
        foreach my $cutoff(@cutoffs){
            ...
            my $input_file = "../../../output/${tissue}/Cis_eQTL/${group}_cis_eQTL/interval_18_filter/6_5000/${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
            ...
            my $output_dir = "../../../output/${tissue}/Cis_eQTL/annotation/interval_18_filter/6_5000/ALL/${type}/${group}/${cutoff}"; 
            # mkdir $PMID;
            # #------------
            if(-e $output_dir){
