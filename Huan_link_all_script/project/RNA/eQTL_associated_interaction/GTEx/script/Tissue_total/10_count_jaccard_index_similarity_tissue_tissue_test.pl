...
my $fo1 = "../../output/Tissue_total/10_tissue_pair_ovelap_absolute1.txt.gz";
open my $O1, "| gzip >$fo1" or die $!;
print $O1 "Chr1\tstart1\tend1\tChr2\tstart2\tend2\ttissue1\ttissue2\n";

my $fo2 = "../../output/Tissue_total/10_tissue_pair_out_ovelap_absolute1.txt.gz";
open my $O2, "| gzip >$fo2" or die $!;
print $O2 "tissue1_Chr\ttissue1_start\ttissue1_end\ttissue1\ttissue2\n";

my $fo3 = "../../output/Tissue_total/10_tissue_pair_overlap_index_and_related_number1.txt.gz";
...
my $fo4 = "../../output/Tissue_total/10_tissue_pair_overlap_index1.txt.gz";
    ...
    foreach my $tissue2(@tissues){
        ...
        unless ($tissue1 eq $tissue2){
            ...
            if(exists $hash1{$pair} || $hash1{$reverse_pair}){ #防止重复
                ...
                my $command1 = "bedtools intersect -f 1 -a $file1 -b $file2 -wo >tmp3.bed";
                my $command2 = "bedtools intersect -f 1 -a $file2 -b $file1 -wo >tmp4.bed";
                system $command1;
                system $command2;
