        ...
        foreach my $group(@groups){
            foreach my $number(@numbers){
                foreach my $cutoff(@cutoffs){
                    ...
                    my $input_file = "/share/data0/QTLbase/huan/GTEx/random_segment/mean_hotspot/${tissue}/hotspot/${number}/interval_18/${tissue}_segment_hotspot_cutoff_${cutoff}.bed.gz";
                    # my $input_file = "/share/data0/QTLbase/huan/GTEx/random_select_exclude_eQTL/${tissue}/${group}/${number}/interval_18/${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
                    ...
                    my $output_dir = "/share/data0/QTLbase/huan/GTEx/random_segment/mean_hotspot/${tissue}/annotation/interval_18/${number}/${type}/${group}/${cutoff}"; 
                    # mkdir $PMID;
                    # #------------
                    if(-e $output_dir){
