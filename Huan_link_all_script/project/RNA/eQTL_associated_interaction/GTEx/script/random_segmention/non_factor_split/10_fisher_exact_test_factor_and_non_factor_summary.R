...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_segment/mean_hotspot/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/")
org1<-read.table("081_sum_random_result.txt",header =  T,sep = "\t") %>% as.data.frame()
...
write.table(rs,"10_fisher_exact_test_result_factor_summary.txt",row.names = F, col.names = T,quote =F,sep="\t")
