#/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_segment/mean_hotspot/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/081_sum_random_result.txt和
...
#得/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_segment/mean_hotspot/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/11_merge_random_and_original_prepare_number_ROC_factor_count.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_segment/mean_hotspot/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/11_merge_random_and_original_prepare_number_ROC_factor_count.txt";
...
my $f2 ="/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/08_prepare_number_ROC_factor_count.txt";
# open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n"; 

my $f3 ="/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_segment/mean_hotspot/Cis_eQTL/ROC/interval_18/ALL/split_non_factor/081_sum_random_result.txt";
# open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件
