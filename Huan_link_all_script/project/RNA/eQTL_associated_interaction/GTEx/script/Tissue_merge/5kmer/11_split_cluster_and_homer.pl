...
for(my $i=0;$i<6;$i++){
    # print "$i\n";
    my $f1 = "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/kmer/5/communities.bed.gz";
    ...
    my $fo1 = "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/kmer/5/homer/communities_${i}.bed";
    ...
    close($O1);
    my $output_dir = "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/kmer/5/homer/${i}/";
    if(-e $output_dir){
