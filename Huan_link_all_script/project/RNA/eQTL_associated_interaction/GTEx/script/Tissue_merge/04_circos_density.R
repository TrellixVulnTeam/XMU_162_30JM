...
#--------------------------
circos.clear()
pdf("4_circos_hotspot_density_all_tissue_spe_10kb.pdf")
par(mar = c(2, 2, 2, 2))
...
circos.genomicDensity(tissue_merge, col = c("#F5A962"), track.height = 0.1,ylim.force=T,window.size = 1e4)
...
circos.clear()
pdf("16_circos_hotspot_density_all_tissue_spe_test.pdf")
par(mar = c(2, 2, 2, 2))
circos.par(start.degree = 90)
circos.initializeWithIdeogram(species= "hg19",chromosome.index = paste0("chr", 1:22))
# circos.genomicDensity(tissue_merge, col = c("#F8C7A0"), track.height = 0.1)
circos.genomicDensity(tissue_merge, col = c("#F5A962"), track.height = 0.1)
circos.genomicDensity(Breast, col = c("#B6C867"), track.height = 0.1)
# circos.genomicDensity(Liver, col = c("#B6C867"), track.height = 0.1)
circos.genomicDensity(Lung, col = c("#01937C"), track.height = 0.1)
# circos.genomicDensity(Ovary, col = c("#125D98"), track.height = 0.1)
circos.genomicDensity(Pancreas, col = c("#3C8DAD"), track.height = 0.1)
# circos.genomicDensity(Prostate, col = c("#F5A962"), track.height = 0.1)
circos.genomicDensity(Thyroid, col = c("#2541B2"), track.height = 0.1)
circos.genomicDensity(Whole_Blood, col = c("#C84B31"), track.height = 0.1)
dev.off()
print("finish")
# circos.clear()