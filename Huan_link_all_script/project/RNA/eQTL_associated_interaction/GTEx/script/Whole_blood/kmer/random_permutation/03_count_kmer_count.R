...
#----------------------------point plot
png("./figure/Kmer_occur_count.png")
...
png("./figure/Kmer_occur_ratio.png")
...
pdf("./figure/hit_random_ratio_Kmer_ratio.pdf",width=3.2, height=3)
...
dev.off()
#-------------------
pdf("./figure/hit_random_ratio_Kmer_count.pdf",width=3.2, height=3)
