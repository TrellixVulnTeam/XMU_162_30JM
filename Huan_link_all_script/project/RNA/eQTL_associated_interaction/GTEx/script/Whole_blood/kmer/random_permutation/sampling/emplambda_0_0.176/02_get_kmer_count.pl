...
chdir "/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/random/background_original_random/0_0.176/";
...
for (my $i=1;$i<1001;$i++){
    ...
    my $input = "sorted_${i}_resemble_${tissue}_segment_${group}_cutoff_${cutoff}.fa";
    $ENV{'i'} = $i;
    $ENV{'input'} = $input ;
