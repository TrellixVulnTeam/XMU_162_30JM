...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/20_${tissue}_count_hotspot_in_factor.txt.gz";
open my $O1, "| gzip >$fo1" or die $!;
print $O1 "Cutoff\tnum_of_hotspot_hit_factor\tnum_all_hotspot\thit_ratio\n";
my $fo2 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/20_${tissue}_count_hotspot_in_factor_pos.txt.gz";
open my $O2, "| gzip >$fo2" or die $!;
print $O2 "chr\tstart\tend\tfactor\tcutoff\n";

my $fo3 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/20_${tissue}_count_hotspot_in_per_factor_ratio.txt.gz";
...
foreach my $cutoff(@cutoffs){
    ...
    my $anno_dir = "../../../output/Whole_Blood/Cis_eQTL/annotation/interval_18_filter/6_5000/ALL/${type}/${group}/${cutoff}"; 
