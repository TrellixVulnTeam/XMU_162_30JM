...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Whole_Blood/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/08_whole_Blood_prepare_number_ROC_factor_count_re.txt";
...
foreach my $factor(@factors){
    ...
    foreach my $cutoff(@cutoffs){
        my $factor_hotspot_file = "../../../output/Whole_Blood/Cis_eQTL/annotation/interval_18_filter/6_5000/ALL/factor/hotspot/${cutoff}/${factor}_whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz";
        my $non_factor_hotspot_file = "../../../output/Whole_Blood/Cis_eQTL/annotation/interval_18_filter/6_5000/ALL/non_factor_split/hotspot/${cutoff}/non_${factor}_whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz";
        #--------------------------------------get size of file 
