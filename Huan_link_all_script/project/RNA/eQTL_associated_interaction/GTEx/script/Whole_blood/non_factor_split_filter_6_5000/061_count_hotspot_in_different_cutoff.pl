...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/061_hotspot_in_different_cutoff_interval_18.txt";
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
print $O1 "Cutoff\tNumber_of_hotspot\n";

foreach my $cutoff(@cutoffs){
    my $hotspot_file = "../../../output/${tissue}/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6_5000/whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz";
