...
tissue = "Whole_Blood"
ttype= "up"
# final_dir <- paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/",tissue,"/separate_up_down_eQTL/Cis_eQTL/",ttype,"_NHP/")
final_dir <- paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/",tissue,"/separate_up_down_cis_eQTL/Cis_eQTL/",ttype,"/NHP/")
...
#     print(file)
    ...
    org <- read.table(paste0("../../../",ttype,"_",tissue,"_cis_eQTL_1kg_Completion.txt.gz"),header = T,sep = "\t") %>% as.data.frame()
    number_list <- 18
