###../../output/${tissue}/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_${tissue}.txt.gz 时得不同cutoff下的hotspot(segment),"../../output/${tissue}/Cis_eQTL/hotspot_cis_eQTL/interval_${j}/${tissue}_segment_hotspot_cutoff_${cutoff}_chr1_22.bed.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
foreach my $d_type(@d_types){
    ...
    print "$d_type\tstart\n";
    my $f1 = "../../../output/${tissue}/separate_up_down_cis_eQTL/Cis_eQTL/${d_type}/NHP/NHPoisson_emplambda_interval_${interval}_cutoff_7.3_${tissue}.txt.gz";
    ...
    my $output_dir = "../../../output/${tissue}/separate_up_down_cis_eQTL/Cis_eQTL/${d_type}/hotspot/interval_${interval}";
    if(-e $output_dir){
