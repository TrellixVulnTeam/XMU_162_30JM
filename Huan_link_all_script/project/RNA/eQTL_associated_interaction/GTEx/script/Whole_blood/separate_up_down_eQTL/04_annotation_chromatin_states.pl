#interval_18 时，对"../../../output/${tissue}/separate_up_down_cis_eQTL/Cis_eQTL/${d_type}/hotspot/interval_18/${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz"用annotation_chromatin_states_interval18.sh进行annotation,得$output_dir/$factor_$input_file_base_name
#extend 100bp
#!/usr/bin/perl
use warnings;
use strict; 
...
foreach my $d_type(@d_types){
    my $input_file = "../../../output/${tissue}/separate_up_down_cis_eQTL/Cis_eQTL/${d_type}/hotspot/interval_18/${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
    ...
    my $output_dir = "../../../output/${tissue}/separate_up_down_cis_eQTL/Cis_eQTL/${d_type}/annotation/chromatin_state/${cutoff}"; #---------
    # mkdir $PMID;
    # #------------
    if(-e $output_dir){
