...
write.table(all_fisher,"./figure/0_0.176/compare_0_0.176_jaacard_index_fisher_test_two_side.txt",row.names = F, col.names = T,quote =F,sep="\t")
...
write.table(all_fisher,"./figure/0_0.176/compare_0_0.176_jaacard_index_fisher_test_greater.txt",row.names = F, col.names = T,quote =F,sep="\t")
