...
print "cutoff\t$cutoff\n";
my $fo3 = "../../../../../output/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_${j}/sampling/whole_blood_segment_hotspot_cutoff_more_0_and_less_than_0.176.bed.gz";
...
foreach my $chr (sort keys %hash1){
    ...
    foreach my $v(@vs){
        ...
        if ($emplambda >0 && $emplambda<0.176){
            push @contents,$v;
            # print  "$chr\t$v\n";
            push @results,$v;
