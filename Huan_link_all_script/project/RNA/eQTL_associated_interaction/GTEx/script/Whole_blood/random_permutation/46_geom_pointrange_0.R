...
org<-read.table("compare_0_jaacard_index_fisher_test_two_side.txt",header = T,sep = "\t") %>% as.data.frame()
...
pdf("fisher_test_0_jaacard_index_forest_plot.pdf",height = 3.5,width = 4) #
