#对/share/data0/QTLbase/huan/GTEx/${tissue}/Cis_eQTL/interval_18/annotation/ALL/${group}/${cutoff}/$type/*的marker进行count,得"$out_dir/${type}_histone_marker.txt.gz";
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 = "$out_dir/${type}_histone_marker.txt.gz";
