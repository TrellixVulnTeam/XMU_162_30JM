...
my $input_dir = "/share/data0/QTLbase/huan/GTEx/${tissue}/Cis_eQTL/interval_18/annotation/ALL/${group}/${cutoff}/background_original_random/$cutoff2";;
...
my $fo1 = "$out_dir/${cutoff2}_jaccard_index_histone_marker.txt.gz";
...
for (my $i=1;$i<10001;$i++){
    foreach my $mark (@markers){
        ...
        my $resemble_dir=  "../../../../../output/${tissue}/Cis_eQTL/${group}_cis_eQTL/interval_18_random/background_original_random/${cutoff}/$cutoff2";
        my $f3 = "${resemble_dir}/${i}_resemble_${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
