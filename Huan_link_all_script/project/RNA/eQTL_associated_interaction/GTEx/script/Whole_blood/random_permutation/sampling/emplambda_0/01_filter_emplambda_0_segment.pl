###过滤出../../../../../output/Whole_Blood/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_Whole_Blood.txt.gz 中emplambda$emplambda ==0，得 "../../../../../output/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_${j}/sampling/whole_blood_segment_hotspot_cutoff_0.bed.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
print "cutoff\t$cutoff\n";
my $fo3 = "../../../../../output/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_${j}/sampling/whole_blood_segment_hotspot_cutoff_${cutoff}.bed.gz";
