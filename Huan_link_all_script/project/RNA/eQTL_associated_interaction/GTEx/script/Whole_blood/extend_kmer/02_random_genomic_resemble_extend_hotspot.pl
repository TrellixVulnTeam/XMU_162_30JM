...
my $input_file = "../../../output/${tissue}/Cis_eQTL/${group}_cis_eQTL/interval_18/extend_whole_blood_segment_${group}_cutoff_${cutoff}.bed.gz";
my $input_file_base_name = basename($input_file);
$input_file_base_name =~ s/whole_blood/Whole_Blood/g;
my $output_dir=  "../../../output/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_random/original_random0.176_extend_6";
