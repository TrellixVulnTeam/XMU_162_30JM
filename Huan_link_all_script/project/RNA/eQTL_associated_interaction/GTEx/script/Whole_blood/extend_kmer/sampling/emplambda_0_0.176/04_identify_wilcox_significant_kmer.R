...
load("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/figure/hotspot_kmer_need_test_value.Rdata")
...
#---------
setwd("/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/random/0_0.176/fa")
...
a <-mclapply(c(1:100), ProcessBedGz, mc.cores = 10)
all_random_kmer_need_test_value <-do.call(rbind,a)

setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/sampling/emplambda_0_0.176/figure/")
...
#------------------------
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/sampling/emplambda_0_0.176/")

write.table(rs,"./figure/hotspot_emplambda_0_0.176_random_kmer_wilcox.txt",row.names = F, col.names = T,quote =F,sep="\t")
