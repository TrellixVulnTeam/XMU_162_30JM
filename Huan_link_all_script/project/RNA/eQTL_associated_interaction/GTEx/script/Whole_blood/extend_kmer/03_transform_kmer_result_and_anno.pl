...
my $f1 = "/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/communities.csv";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
my $fo1 = "/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/communities.bed.gz";
...
$ENV{'input_file'}  = $fo1;
$ENV{'output_dir'}  = "/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/anno";
...
#     my $command = "bedtools intersect -a $fo1  -b $factor_file -wa |sort -u |gzip >/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/ALL/factor_anno/${factor}.bed.gz" ;
#     print "$factor_file\n";
#     system $command;
# }
