...
setwd("/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/anno")
...
final_data<-filter(anno_count,cluster_number!=4)
figure_used <-acast(final_data,Class~cluster_number)
res =chisq.test(figure_used,simulate.p.value = TRUE)
expected = res$expected
roe = figure_used/expected
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/figure/")
save(roe,file="6kmer_roe.Rdata")
ROE <-data.frame(roe,stringrAsFactors =F)
...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/figure/")
# setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/7kmer/figure/")
