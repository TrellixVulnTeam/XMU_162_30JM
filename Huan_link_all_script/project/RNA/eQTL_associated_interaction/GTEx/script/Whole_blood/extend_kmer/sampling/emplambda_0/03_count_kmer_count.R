...
setwd("/share/data0/QTLbase/huan/GTEx/Whole_Blood/Cis_eQTL/hotspot_cis_eQTL/interval_18_filter/6/kmer/extend/random/0/fa")
# rs<-data.frame()
# for(i in c(1:1000)){
#     print(i)
...
setwd("/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/script/Whole_blood/extend_kmer/sampling/emplambda_0/")

#----------------------------point plot
png("./figure/emplambda_0_Kmer_occur_count.png")
...
png("./figure/emplambda_0_Kmer_occur_ratio.png")
...
#------------summary boxplot
pdf("./figure/emplambda_0_Kmer_occur_boxplot_ratio.pdf",width=3.5, height=3.5)
...
pdf("./figure/emplambda_0_hit_random_ratio_Kmer_ratio.pdf",width=3.2, height=3)
...
dev.off()
#-------------------
pdf("./figure/emplambda_0_hit_random_ratio_Kmer_count.pdf",width=3.2, height=3)
