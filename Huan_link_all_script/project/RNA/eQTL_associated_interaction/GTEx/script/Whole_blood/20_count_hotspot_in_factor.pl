##根据"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/061_hotspot_in_different_cutoff_interval_18_re.txt记录的hotspot数目，和annotation信息得每个cutoff下hit住factor的hotspot的比例文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_${tissue}_count_hotspot_in_factor.txt"; 得每个cutoff下被每种factor hit住hotspot的比例文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_${tissue}_count_hotspot_in_per_factor_ratio.txt";得每个cutoff下被每种factor hit住hotspot的文件"/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_count_hotspot_in_factor_pos.txt.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my %hash1;
my $f1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/061_hotspot_in_different_cutoff_interval_18_re.txt";
...
my $fo1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_${tissue}_count_hotspot_in_factor.txt";
# open my $O1, "| gzip >$fo1" or die $!;
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
print $O1 "Cutoff\tnum_of_hotspot_hit_factor\tnum_all_hotspot\thit_ratio\n";
my $fo2 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_${tissue}_count_hotspot_in_factor_pos.txt.gz";
open my $O2, "| gzip >$fo2" or die $!;
# open my $O2, '>', $fo2 or die "$0 : failed to open output file '$fo2' : $!\n";
print $O2 "chr\tstart\tend\tfactor\tcutoff\n";

my $fo3 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/20_${tissue}_count_hotspot_in_per_factor_ratio.txt";
...
foreach my $cutoff(@cutoffs){
    ...
    my $anno_dir = "../../output/${tissue}/Cis_eQTL/annotation/interval_18/ALL/${type}/${group}/${cutoff}"; 
    my $base_file = "whole_blood_segment_${group}_cutoff_${cutoff}.bed.gz";
