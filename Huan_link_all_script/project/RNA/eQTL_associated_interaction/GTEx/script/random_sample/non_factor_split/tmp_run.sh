...
perl 11_merge_random_and_original_prepare_number_ROC_factor_count.pl
echo -e "11_merge_random_and_original_prepare_number_ROC_factor_count\n"
perl 12_merge_random_and_original_fisher_exact_test.pl
echo -e "12_merge_random_and_original_fisher_exact_test\n"


perl 081_sum_random_result_re.pl 
echo -e "081_sum_random_result_re\n"
perl 11_merge_random_and_original_prepare_number_ROC_factor_count_re.pl
echo -e "11_merge_random_and_original_prepare_number_ROC_factor_count_re\n"