...
my @groups = ("hotspot");
my $group = "hotspot";
my $output_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/random_sample/Cis_eQTL/ROC/interval_18/ALL/split_non_factor_filter/6_5000/";
if(-e $output_dir){
...
my $fo1 = "$output_dir/08_prepare_number_ROC_factor_count_re.txt";
    ...
    foreach my $factor(@factors){
        ...
        foreach my $number(@numbers){
            foreach my $cutoff(@cutoffs){
                my $factor_hotspot_file = "/share/data0/QTLbase/huan/GTEx/random_select/${tissue}/annotation/interval_18_filter/6_5000/ALL/${number}/factor/${group}/${cutoff}/${factor}_${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
                my $non_factor_hotspot_file = "/share/data0/QTLbase/huan/GTEx/random_select/${tissue}/annotation/interval_18_filter/6_5000/ALL/${number}/non_factor_split/${group}/${cutoff}/non_${factor}_${tissue}_segment_${group}_cutoff_${cutoff}.bed.gz";
                #--------------------------------------get size of file 
