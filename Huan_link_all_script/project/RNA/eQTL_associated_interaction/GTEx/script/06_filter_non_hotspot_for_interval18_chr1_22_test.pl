...
my @cutoffs;
# for (my $i=0.05;$i<0.95;$i=$i+0.05){ #对文件进行处理，把所有未定义的空格等都替换成NONE
#     push @cutoffs,$i;
#     # print "$i\n";
# }
push @cutoffs,0.01;
...
foreach my $j(@interval){
    print "$j\n";
    # my $f1 = "../output/Whole_Blood/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_Whole_Blood.txt.gz";
