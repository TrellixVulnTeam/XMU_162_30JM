...
#         close($O3);
#         close($O4);
#         my $command1 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.eur.hg19.SNPs --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo2 --out ../output/clump/${database}_${tissue}_cis.eSNP";
#         my $command2 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.eur.hg19.SNPs --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo3 --out ../output/clump/${database}_${tissue}_trans.eSNP";
#         my $command3 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.eur.hg19.SNPs --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo4 --out ../output/clump/${database}_${tissue}_unknown_cis_trans.eSNP";
