...
my $fo1 = "../output/06_database_and_tissue_info.txt";
...
# }
#-------------------#sub1
push @{$hash1{Blood_eQTL_browser}},$Blood_eQTL_browser_tissue;
push @{$hash1{CAGE}},$CAGE_tissue;
push @{$hash1{eQTL_Catalog}},$eQTL_Catalog_tissue;
push @{$hash1{eQTL_databases}},$eQTL_databases_tissue;
push @{$hash1{eQTLGen}},$eQTLGen_tissue;
push @{$hash1{SEEQTL}},$SEEQTL_tissue;
#---------------------------#sub2
...
foreach my $database(sort keys %hash1){
    ...
    foreach my $tissue(@tissues){
        ...
        close($O3);
        close($O4);
        my $command1 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.shapeit2.eur.hg19.all.SNPs.uniq --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo2 --out ../output/clump/${database}_${tissue}_cis.eSNP";
        my $command2 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.shapeit2.eur.hg19.all.SNPs.uniq --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo3 --out ../output/clump/${database}_${tissue}_trans.eSNP";
        my $command3 = "plink --bfile /home/huanhuan/ref_data/1000g/1kg_phase3_v5_hg19/EUR/1kg.phase3.v5.shapeit2.eur.hg19.all.SNPs.uniq --threads 2 --clump-r2 0.2 --clump-kb 500 --clump $fo4 --out ../output/clump/${database}_${tissue}_unknown_cis_trans.eSNP";
