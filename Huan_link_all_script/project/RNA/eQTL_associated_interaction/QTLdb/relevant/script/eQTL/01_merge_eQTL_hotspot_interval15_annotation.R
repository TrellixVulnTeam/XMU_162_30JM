...
org1<-read.table("hotspot/interval_15_segment_hotspot.bed.gz",header = F,sep = "\t") %>% as.data.frame()
colnames(org1)[1]<-"chr"
...
# for (file in file2){
  name <- str_replace(file,"QTLbase_all_eQTL_interval_hotspot_15_","")  #replace
