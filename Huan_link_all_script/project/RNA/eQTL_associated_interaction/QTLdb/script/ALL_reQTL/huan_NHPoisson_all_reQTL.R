...
pwd_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_reQTL"
...
for (cutoff in cutoffs){
    for (j in interval){
        ...
        for(i in c(1:22)){
            ...
            figure_name <-paste(dir_name,"/emplambda_all_reQTL_int_",j,"bp_chr",i,".png", sep = "")
        ...
        output_file2<-paste("../../output/ALL_reQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_reQTL.txt", sep = "")
        output_file3<-paste("../../output/ALL_reQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_reQTL.txt", sep = "")
