zless "/share/data0/QTLbase/data/QTLbase_download_data_sourceid.txt"  | cut -f7 | sort -u > ../output/unique_journal_source.txt
# ../output/unique_journal_source_IF.txt #为../output/unique_journal_source.txt 注释 IF,得../output/unique_journal_source_IF.txt
perl 0011_filter_paper_of_QC.pl # 筛选../output/unique_journal_source_IF.txt中IF>=5的journal,从"/share/data0/QTLbase/data/QTLbase_download_data_sourceid.txt"筛选得../output/0011_QTLbase_download_data_sourceid_QC.txt
perl 0012_QC_xQTL.pl #利用../output/0011_QTLbase_download_data_sourceid_QC.txt，提取/share/data0/QTLbase/data/xQTL, 得/share/data0/QTLbase/2020_12_2_QC/xQTL


#------------------------------------------------------------
            perl 0013_merge_all_kinds_QTL.pl #将/share/data0/QTLbase/2020_12_2_QC/中的各种QTL merge到一起，得../output/01_all_kinds_QTL.txt
...
#----------------------------------------------QTL hotspot
        ...
        perl 0014_merge_pop_tissue.pl ##将../output/01_all_kinds_QTL.txt 中chr22过滤得../output/chr22.txt,过滤chr22中eur得../output/chr22_eur.txt
    # #得所有的具有 pop 和tissue的文件得../output/merge_QTL_all_QTLtype_pop.txt.gz
        perl 0015_judge_xQTL_cis_trans.pl ##将../output/merge_QTL_all_QTLtype_pop.txt.gz 按照1MB和10MB划分cis和trans， 分别得../output/merge_QTL_all_QTLtype_pop_cistrans.txt.gz
...
#-----------------
perl 0016_merge_1kg_sub_pop.pl  #将/share/data0/1kg_phase3_v5_hg19/五个人种的all_SNP merge在一起得../output/all_1kg_phase3_v5_hg19_snp.txt.gz

perl 01_Completion_snp_for_xQTL_by_1kg.pl # 用../output/all_1kg_phase3_v5_hg19_snp.txt.gz 补全"/share/data0/QTLbase/2020_12_2_QC/${QTL}.txt.gz"; 得../output/ALL_${QTL}/01_merge_QTLbase_all_pop_${QTL}_1kg_Completion.txt.gz
