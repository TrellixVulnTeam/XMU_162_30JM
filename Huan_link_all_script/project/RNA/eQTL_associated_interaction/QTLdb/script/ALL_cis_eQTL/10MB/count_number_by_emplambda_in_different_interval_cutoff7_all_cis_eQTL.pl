...
my $fo1 = "../../../output/ALL_cis_eQTL/10MB/count_number_by_emplambda_in_different_interval_cutoff_7_all_cis_eQTL.txt";
...
foreach my $i(@intervals) { #interval
    my $f1 = "../../../output/ALL_cis_eQTL/10MB/NHPoisson_emplambda_interval_${i}_all_cis_eQTL.txt";
