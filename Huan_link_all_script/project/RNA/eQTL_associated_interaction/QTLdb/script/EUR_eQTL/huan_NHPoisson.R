...
cutoff = 7
for (j in interval){
    dir_name = paste("cutoff_",cutoff,"_int",j, sep = "")
    #----------------------------------mkdir_dir
    ...
    for(i in c(1:22)){
        ...
        figure_name <-paste(dir_name,"/emplambda_eqtl_EUR_int_",j,"bp_chr",i,".png", sep = "")
    ...
    output_file1<-paste("../output/NHPoisson_POTevents_Px_cutoff_",cutoff,".txt", sep = "")
    output_file2<-paste("../output/NHPoisson_emplambda_interval_",j,".txt", sep = "")
    output_file3<-paste("../output/NHPoisson_POTevents_inddat_cutoff_",cutoff,".txt", sep = "")
