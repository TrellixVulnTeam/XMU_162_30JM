 #统计../output/NHPoisson_POTevents_inddat_cutoff_${i}.txt中每个阶段QTL的数目，得../output/count_number_by_emplambda_in_different_interval_cutoff_7.txt
...
my $fo1 = "../output/count_number_by_emplambda_in_different_interval_cutoff_7.txt";
...
for (my $i=10000;$i<70000;$i=$i+10000){ #interval
    my $f1 = "../output/NHPoisson_POTevents_inddat_cutoff_${i}.txt";
