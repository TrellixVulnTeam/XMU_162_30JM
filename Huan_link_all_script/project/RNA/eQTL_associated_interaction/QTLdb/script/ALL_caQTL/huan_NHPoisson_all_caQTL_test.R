...
pwd_dir = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/figure/ALL_caQTL"
...
org_pop <- filter(org,QTL_type == "caQTL")
# org_pop <- org
#--------------------500k
...
#     for (j in interval){
    ...
    cutoff = 7.3
    j=1000
        dir_name = paste("all_caQTL_cutoff_",cutoff,"_int",j, sep = "")
        #----------------------------------mkdir_dir
        ...
        # for(i in c(1:22)){
            ...
            figure_name <-paste(dir_name,"/emplambda_all_caQTL_int_",j,"bp_chr",i,".png", sep = "")
            ...
            print(i)
        # }
        output_file1<-paste("../../output/ALL_caQTL/NHPoisson_POTevents_Px_cutoff_",cutoff,"_all_caQTL_test.txt", sep = "")
        output_file2<-paste("../../output/ALL_caQTL/NHPoisson_emplambda_interval_",j,"cutoff_",cutoff,"_all_caQTL_test.txt", sep = "")
        output_file3<-paste("../../output/ALL_caQTL/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_all_caQTL_test.txt", sep = "")
