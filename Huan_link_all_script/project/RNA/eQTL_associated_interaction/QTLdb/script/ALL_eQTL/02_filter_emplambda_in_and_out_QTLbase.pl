...
my $f1 = "../../output/ALL_eQTL/QTLbase_all_eQTL.bed";
...
for(my $i=6;$i<33;$i++){
    ...
    my $f2 = "../../output/ALL_${xQTL}/NHPoisson_emplambda_interval_${i}cutoff_7.3_all_${xQTL}.txt.gz";
    # open my $I3, '<', $f3 or die "$0 : failed to open input file '$f3' : $!\n"; 
    open( my $I2 ,"gzip -dc $f2|") or die ("can not open input file '$f2' \n"); #读压缩文件
    my $fo1 = "../../output/ALL_${xQTL}/QTLbase_NHPoisson_emplambda_interval_${i}_cutoff_7.3_all_${xQTL}.txt.gz";
    open my $O1, "| gzip >$fo1" or die $!;
    my $fo2 = "../../output/ALL_${xQTL}/1kg_out_QTLbase_NHPoisson_emplambda_interval_${i}_cutoff_7.3_all_${xQTL}.txt.gz";
