###QTLs =eQTL在interval = 18时的NON hotspot(segment),得"../output/ALL_${QTL}/un_hotspot/interval_${j}_segment_UNhotspot.txt.gz", 得point 热点../../output/ALL_${QTL}/un_hotspot/interval_${j}_point_UNhotspot.txt.gz
use warnings;
use strict; 
use utf8;
