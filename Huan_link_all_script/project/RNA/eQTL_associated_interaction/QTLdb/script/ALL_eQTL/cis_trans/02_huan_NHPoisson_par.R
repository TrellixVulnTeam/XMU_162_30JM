...
ProcessBedGz <- function(j = NULL, org = NULL, cutoff = NULL, name = NULL){
    ...
    print(file)
    output_file1<-paste("./NHP/",name,"/NHPoisson_POTevents_Px_cutoff_",cutoff,"_",name,"_eQTL.txt", sep = "")
    output_file2<-paste("./NHP/",name,"/NHPoisson_emplambda_interval_",j,"_cutoff_",cutoff,"_",name,"_eQTL.txt", sep = "")
    output_file3<-paste("./NHP/",name,"/NHPoisson_POTevents_inddat_cutoff_",cutoff,"_",name,"_eQTL.txt", sep = "")
...
files<- list.files("~/project/RNA/eQTL_associated_interaction/QTLdb/output/ALL_eQTL/cis_trans/","txt.gz")
#----------------------------------------------

setwd("~/project/RNA/eQTL_associated_interaction/QTLdb/output/ALL_eQTL/cis_trans/")
cutoff =7.3
number_list <- c(6,7,8,9,12,15,18)
# number_list <- c(12,15,18)
