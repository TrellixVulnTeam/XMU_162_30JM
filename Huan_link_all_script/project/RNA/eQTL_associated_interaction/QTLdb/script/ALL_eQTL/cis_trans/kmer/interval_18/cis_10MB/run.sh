...
seekr_kmer_counts ../../../../../../output/ALL_eQTL/cis_trans/kmer/interval_18/cis_10MB/interval_18_cutoff_7.3_cis_10MB_eQTL_segment_hotspot_length_more_than6_random_select_fraction_0.1.fa -o 6mers.csv -mv mean.npy -sv std.npy
