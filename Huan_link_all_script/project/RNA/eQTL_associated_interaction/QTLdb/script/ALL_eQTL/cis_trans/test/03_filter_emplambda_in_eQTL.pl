#将../../../output/ALL_eQTL/cis_trans/NHPoisson_emplambda_interval_1000_cutoff_7.3_${name}_eQTL.txt.gz 中的QTLbase中../../../output/merge_QTL_all_QTLtype_pop_cistrans.txt.gz的eQTL数据过滤出来，
...
my $fo2 = "../../../output/ALL_eQTL/cis_trans/QTLbase_NHPoisson_emplambda_interval_1000_cutoff_7.3_all_cis_trans_eQTL.txt.gz";
