...
seekr_kmer_counts ../../../../../output/ALL_eQTL/cis_trans/kmer/interval_9/trans_1MB/interval_9_cutoff_7.3_trans_1MB_eQTL_segment_hotspot_length_more_than6.fa -o 6mers.csv -mv mean.npy -sv std.npy
