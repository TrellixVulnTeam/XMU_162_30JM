...
#-------------------------------------
setwd(paste("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_15/annotation",group,type,sep="/"))


files<- list.files(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_15/annotation",group,type,sep="/"),"bed.gz")
...
# gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/annotation_out/01_annotation_merge_",group,"_",type,".txt.gz",sep = ""), "w")
gz1 <- gzfile(paste("~/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_eQTL/cis_trans/interval_15/annotation_out/05_annotation_merge_",group,"_",type,".txt.gz",sep = ""), "w")
