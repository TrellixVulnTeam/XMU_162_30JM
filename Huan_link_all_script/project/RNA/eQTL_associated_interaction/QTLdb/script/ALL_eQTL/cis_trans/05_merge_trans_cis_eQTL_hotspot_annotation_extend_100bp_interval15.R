...
for (fraction in fractions){
  for(group in groups){
    ...
    mclapply(types, function(type){
      ...
      #-------------------------------------
      setwd(paste0("/state/partition1/huan/QTLdb/output/ALL_eQTL/cis_trans/fisher_exact_test_extend_100bp/annotation/interval_",interval,"/",group,"/",type,"/",fraction,"/"))


      files<- list.files(paste0("/state/partition1/huan/QTLdb/output/ALL_eQTL/cis_trans/fisher_exact_test_extend_100bp/annotation/interval_",interval,"/",group,"/",type,"/",fraction,"/"),"bed.gz")
      ...
      gz1 <- gzfile(paste("/state/partition1/huan/QTLdb/output/ALL_eQTL/cis_trans/fisher_exact_test_extend_100bp/annotation_out/",group,"/05_annotation_merge_",type,"_interval_",interval,"_overlap_fraction_",fraction,".txt.gz",sep = ""), "w")
