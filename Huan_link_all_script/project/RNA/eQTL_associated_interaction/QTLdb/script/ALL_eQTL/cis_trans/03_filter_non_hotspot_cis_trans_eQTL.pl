###QTLs =eQTL,在@interval = (6,7,8,9,12,15)时的non hotspot(segment),得"../../../output/ALL_${QTL}/cis_trans/non_hotspot/interval_${j}_cutoff_7.3_${type}_${QTL}_segment_non_hotspot.txt.gz";
...
foreach my $QTL(@QTLs){
    ...
    foreach my $type(@types){
        foreach my $j(@interval){
            ...
            my $fo1 = "../../../output/ALL_${QTL}/cis_trans/non_hotspot/interval_${j}_cutoff_7.3_${type}_${QTL}_segment_non_hotspot.txt.gz";
            open my $O1, "| gzip >$fo1" or die $!;
            # print $O1 "chr\tstart\tend\n";
            my $fo2 = "../../../output/ALL_${QTL}/cis_trans/non_hotspot/interval_${j}_cutoff_7.3_${type}_${QTL}_point_non_hotspot.txt.gz";
