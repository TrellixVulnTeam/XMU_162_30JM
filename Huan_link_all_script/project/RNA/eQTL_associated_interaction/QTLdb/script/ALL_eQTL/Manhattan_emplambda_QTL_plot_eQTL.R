...
org1$SNP <-SNP
org1=org1[,c(4,3,2,1)]
figure_name <-paste("cutoff_",cutoff,"_snp_number_in_different_interval_all_",xQTL,"_cex_0.1_single",sep = "")
CMplot(org1,plot.type="m",LOG10=FALSE,threshold=NULL,chr.den.col=NULL,file="jpg",memo=figure_name,dpi=300, cex=0.1,ylab = "Emplambda",file.output=TRUE,verbose=TRUE)
