...
xQTL ="eQTL"
org<-read.table(paste0("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLdb/output/ALL_",xQTL,"/01_merge_QTLbase_all_pop_",xQTL,"_1kg_Completion.txt.gz"),header = T,sep = "\t") %>% as.data.frame()
#----mkdir and set pwd
cutoff = 7.3
#----------------------------------------------
...
for (j in intervals){
    pwd_dir <-paste("/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLdb/figure/ALL_",xQTL,"/",sep="")
