#xQTL 是全部的QTLbase
#将../output/ALL_${xQTL}/QTLbase_NHPoisson_emplambda_interval_1000cutoff_7.3_all_${xQTL}.txt.gz 和 ../output/merge_QTL_all_QTLtype_pop_cistrans.txt.gz merge在一起得
