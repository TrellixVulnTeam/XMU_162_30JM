...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_part_QTL.pdf",height = 6,width = 7)
...
# pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.75_part_QTL.pdf",height = 6,width = 7)
...
# pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.65_part_QTL.pdf",height = 6,width = 7)
# p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
# p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
# print(p1)
# dev.off()
...
# pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.55_part_QTL.pdf",height = 6,width = 7)
# p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
# p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
# print(p1)
# dev.off()
...
# pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.5_part_QTL.pdf",height = 6,width = 7)
# p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
# p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
# print(p1)
# dev.off()
...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.4_part_QTL.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
print(p1)
dev.off()
...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.3_part_QTL.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
print(p1)
dev.off()
...
pdf("histogram_count_number_by_emplambda_interval_1000_cutoff_7.3_emplambda_0.2_part_QTL.pdf",height = 6,width = 7)
p1<-ggplot(org1, aes(x =emplambda,fill =xQTL)) +geom_histogram(position="identity",alpha =0.45) 
p1<-p1+xlab("Emplambda") + ylab("Count")+p_theme
print(p1)
dev.off()
