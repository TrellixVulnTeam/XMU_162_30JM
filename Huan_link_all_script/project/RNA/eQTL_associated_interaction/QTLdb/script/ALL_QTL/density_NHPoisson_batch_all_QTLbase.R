...
i=1
for (j in interval){
    file_name <-paste("../output/NHPoisson_emplambda_interval_",j,"_all_QTLbase.txt", sep = "")
...
pdf("cutoff7_density_plot_in_different_interval_all_QTL.pdf",height = 20,width = 28) 
