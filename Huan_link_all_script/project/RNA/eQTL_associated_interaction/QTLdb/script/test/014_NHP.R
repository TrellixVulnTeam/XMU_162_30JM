...
QTLs =c("QTL","caQTL","cerQTL","eQTL","edQTL","hQTL","lncRNAQTL","mQTL","metaQTL","miQTL","pQTL","reQTL","riboQTL","sQTL")
ProcessBedGz <- function(xQTL = NULL){
...
# }
#----------------------------------------------
QTLs_list <- mclapply(QTLs, ProcessBedGz, mc.cores = 20)
print("finish")
