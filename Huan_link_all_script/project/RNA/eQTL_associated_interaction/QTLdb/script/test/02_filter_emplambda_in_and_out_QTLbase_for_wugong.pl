...
my $f1 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/merge_QTL_all_QTLtype_pop.txt.gz";
...
foreach my $xQTL(@QTLs){
    ...
    my $f2 = "/home/huanhuan/project/RNA/eQTL_associated_interaction/QTLbase/output/ALL_${xQTL}/NHPoisson_emplambda_interval_1000cutoff_7.3_all_${xQTL}.txt.gz";
    # open my $I3, '<', $f3 or die "$0 : failed to open input file '$f3' : $!\n"; 
    open( my $I2 ,"gzip -dc $f2|") or die ("can not open input file '$f2' \n"); #读压缩文件
    my $fo1 = "${xQTL}/test_QTLbase_NHPoisson_emplambda_interval_1000_cutoff_7.3_all_${xQTL}.txt.gz";
    open my $O1, "| gzip >$fo1" or die $!;
    my $fo2 = "${xQTL}/test_1kg_out_QTLbase_NHPoisson_emplambda_interval_1000_cutoff_7.3_all_${xQTL}.txt.gz";
