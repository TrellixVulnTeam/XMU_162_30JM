...
pdf(file = "emplambda_circos_heatmap_mean_interval_800kb.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(2,2,2,2))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 800kb")
