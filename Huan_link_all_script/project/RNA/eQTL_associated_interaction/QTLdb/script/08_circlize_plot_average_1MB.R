...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_times_scale.pdf", height = 8, width = 8, compress = TRUE)
...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_max_min_scale.pdf", height = 8, width = 8, compress = TRUE)
# pdf(file = "test_circos_heatmap_new.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(1,1,1,1))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 1MB")
...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_orginal.pdf", height = 8, width = 8, compress = TRUE)
# pdf(file = "test_circos_heatmap_new.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(1,1,1,1))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 1MB")
...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_times_scale_less.pdf", height = 8, width = 8, compress = TRUE)
# pdf(file = "test_circos_heatmap_new.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(1,1,1,1))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 1MB")
...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_max_min_scale_less.pdf", height = 8, width = 8, compress = TRUE)
# pdf(file = "test_circos_heatmap_new.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(1,1,1,1))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 1MB")
...
pdf(file = "emplambda_QTL_eQTL_mQTL_sQTL_caQTL_hQTL_circos_heatmap_mean_interval_1MB_orginal_less.pdf", height = 8, width = 8, compress = TRUE)
# pdf(file = "test_circos_heatmap_new.pdf", height = 8, width = 8, compress = TRUE)
par(mar = c(1,1,1,1))
plot(c(1,800), c(1,800), type= "n", axes = FALSE, xlab = "", ylab = "",main = "Interval = 1MB")
