...
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V22/test_data/")

# org<-read.table("./output/09_filter_test_data_for_logistic_regression.txt",header = T,sep = "\t") %>% as.data.frame()
org<-read.table("./output/091_filter_target_drug.txt",header = T,sep = "\t") %>% as.data.frame()
...
#                             ,average_dup_svscore,average_inv_svscore,average_tra_svscore,average_cnv_svscore,drug_repurposing)
 ...
 org2<-org %>% dplyr::select(average_effective_drug_target_score,max_effective_drug_target_score,
                             ...
                             median_rwr_normal_P_value,cancer_gene_exact_match_drug_target_ratio,
                             average_mutation_pathogenicity_SNV_INDEL,max_mutation_pathogenicity_SNV_INDEL,
                             average_mutation_pathogenicity_del, max_mutation_pathogenicity_del,
                              average_mutation_pathogenicity_dup,max_mutation_pathogenicity_dup,
                              average_mutation_pathogenicity_inv,max_mutation_pathogenicity_inv,
                              average_mutation_pathogenicity_tra,max_mutation_pathogenicity_tra,
                              average_mutation_pathogenicity_cnv,max_mutation_pathogenicity_cnv
                             )
...
# tune.svm(drug_repurposing ~.,data=org1,gamma = 10^(-100:-1), cost = 10^(0:10),epsilon =10^(-100:3) )
